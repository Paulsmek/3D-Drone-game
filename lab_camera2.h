    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            up = glm::cross(right, forward);  // Ensures orthogonality
        }
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            // Step 1: Calculate the target position based on `distanceToTarget`
            glm::vec3 targetPosition = position + forward * distanceToTarget;

            glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), angle, right);
            position = glm::vec3(rotationMatrix * glm::vec4(position - targetPosition, 1.0f)) + targetPosition;
